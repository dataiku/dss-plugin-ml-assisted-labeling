                            ...
                            <v-popover :trigger="'hover'" :placement="'left'">
                                <div class="al-enabled-widget"
                                    ...
                                    <div class="status">
                                        ...
                                        <span>Active learning {{config.isAlEnabled ? 'enabled' : 'disabled'}}</span>
                                ...
                                <div slot="popover" style="text-align: left; max-width: 500px">
                                    <div v-if="config.isAlEnabled">
                                        ...
                                        <p>The bar represents a halting criterion metric. It shows how efficient the labeling process is with Active Learning
                                            compared to random sampling.</p>
                                        <p>Being in the red zone means that your model should be retrained and
                                    ...
                                    <div v-if="!config.isAlEnabled">
                                        ...
                                        <p>In order to enable Active learning you need to</p>
                                        <ul>
                                            <li>Label some data</li>
                                            <li>Train the model</li>
                                            <li>Generate queries dataset using query sampler recipe</li>
                                        </ul>
                                    </div>
