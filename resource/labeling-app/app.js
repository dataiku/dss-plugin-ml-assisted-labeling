        ...
        fetchBatch: function () {
            ...
            if (this.isLastBatch) {
                ...
                batchPromise.then(data => {
                    ...
                    this.currentALValue = data.al_score;
        ...
        <div class="main">
            ...
            <div v-if="item && !isDone" class="ongoing-training-main">
                <div class="sample-container">
                    <v-popover :trigger="'hover'" style="position: absolute; top: 10px; left: 50%; border-radius: 4px" >
                        ...
                        <div slot="popover"  class="al-status-popover">
                            <div v-if="isAlEnabled">
                                <p>When Active learning is enabled samples are ordered according to the uncertainty score generated by query sampler recipe</p>
                                <p>Efficiency of labeling using Active learning can be controlled by the halting metric:</p>                                
                                <halting-criterion-metric 
                                        :thresholds="[0.25,0.68,0.75]"
                            ...
                            <div v-if="!isAlEnabled">
                                ...
                                <p>You need to generate queries dataset using query sampler recipe to leverage Active learning.</p>
                            </div>
                        </div>
                    </v-popover>
