// Source: https://kyamagu.github.io/bbox-annotator/bbox_annotator.js
...
(function() {
  ...
  this.BBoxAnnotator = (function() {
    function BBoxAnnotator(options) {
      ...
      this.selector = new BBoxSelector(this.image_frame, annotator.options);
      this.initialize_events(this.selector, this.options);
    }
      
    BBoxAnnotator.prototype.update_image = function(image_data, bboxes) {
      ...
      image_element.onload = function() {
        ...
        annotator.annotator_element.css({
          "width": (width + annotator.border_width * 2) + 'px',
          "height": (height + annotator.border_width * 2) + 'px',
          "cursor": "crosshair"
        });
      ...
      image_element.onerror = function() {
        return annotator.annotator_element.text("Invalid image URL: " + url);
      };
