...
app.controller('LabelingSetupController', function($scope) {
    ...
    $scope.datasetParam = {"type":"DATASET", "name":"query_dataset", "label":"Queries", "description":"Dataset containing queries to label ranked by importance", "mandatory": false, "canSelectForeign": false};
